...
import {
  ...
  $BACKGROUND_COLOR_SEMI_WHITE, $BACKGROUND_COLOR_SUPER_BLACK,
...
export const lightTheme: Theme = {
  mode: {
    ...
    desktopHeaderBackground: $BACKGROUND_COLOR_EXTRA_WHITE,
    desktopHeaderBorder: `1px solid rgba(0, 0, 0, 0.06)`,
    desktopHeaderSearchBackground: $BACKGROUND_COLOR_WHITE,
    desktopProfileModalBackground: $BACKGROUND_COLOR_EXTRA_WHITE,
    ...
    feedProfileBackground: $BACKGROUND_COLOR_EXTRA_WHITE,
...
export const darkTheme: Theme = {
  mode: {
    ...
    headerBorder: `none`,
    desktopHeaderBackground: $BACKGROUND_COLOR_EXTRA_BLACK,
    desktopHeaderBorder: `none`,
    desktopHeaderSearchBackground: $BACKGROUND_COLOR_SUPER_BLACK,
    desktopProfileModalBackground: $BACKGROUND_COLOR_EXTRA_BLACK,
    ...
    feedProfileBackground: $BACKGROUND_COLOR_EXTRA_BLACK,
